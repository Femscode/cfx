    ...
    <div class="container mx-auto px-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="step-card bg-white p-8 rounded-xl shadow-lg">
          ...
          <a href="{{ $user->registration_link ?? 'https://capitalxtendng.com/register?referral=2288' }}" class="inline-block bg-accent text-white px-6 py-3 rounded-lg hover:bg-primary transition font-medium">Create My Broker Account</a>
        </div>
        <div class="step-card bg-white p-8 rounded-xl shadow-lg">
